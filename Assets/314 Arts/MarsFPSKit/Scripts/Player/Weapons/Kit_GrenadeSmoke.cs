...
namespace MarsFPSKit
{
    ...
    /// </summary>
    public class Kit_GrenadeSmoke : Kit_BaseNetworked
    {
        /// <summary>
        ...
        public override void OnStartServer()
        {
            ...
            if (!ownerBot)
            {
                Kit_PlayerBehaviour player = networkPlayerManager.GetPlayerBehaviourById(ownerId);
            ...
            {
                Kit_PlayerBehaviour player = main.currentBotManager.GetAliveBot(main.currentBotManager.GetBotWithID(ownerId));
            ...
            rb.linearVelocity = initialPlayerVelocity;
