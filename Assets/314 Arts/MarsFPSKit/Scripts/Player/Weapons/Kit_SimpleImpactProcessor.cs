...
namespace MarsFPSKit
{
    ...
    public class Kit_SimpleImpactProcessor : Kit_ImpactParticleProcessor
    {
        ...
        public override void StartImpactProcessor()
        {
            ...
            {
                main.objectPooling.EnqueueInstantiateable(bulletMarksPrefab, defaultObjectPoolingFill);
            }
            ...
            foreach (BulletImpact bi in bulletImpacts.Values)
            {
                ...
                {
                    main.objectPooling.EnqueueInstantiateable(bi.impactParticle[i], defaultObjectPoolingFill / bi.impactParticle.Length);
                }
            }
        }
        ...
        public override void ProcessImpact(Vector3 pos, Vector3 normal, string materialType, Transform parent = null)
        {
            ...
            GameObject go = main.objectPooling.GetInstantiateable(impactToUse.impactParticle[Random.Range(0, impactToUse.impactParticle.Length)], pos, rot); //Instantiate appropriate particle
            ...
            {
                //Bullet marks
                GameObject bm = main.objectPooling.GetInstantiateable(bulletMarksPrefab, pos + normal * bulletMarksNormalOffset, rot);
                //The instantiated GO should destroy itself
                //Set material
