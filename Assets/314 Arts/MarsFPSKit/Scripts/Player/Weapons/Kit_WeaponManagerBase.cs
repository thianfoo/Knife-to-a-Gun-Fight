...
namespace MarsFPSKit
{
    namespace Weapons
    {
        ...
        /// </summary>
        public abstract class Kit_WeaponManagerBase : Kit_BaseScriptableObject
        {
            ...
            public abstract void OnWeaponsInUseSyncCallback(Kit_PlayerBehaviour pb, SyncList<uint>.Operation operation, int index, uint item);
            ...
            /// <summary>
            /// Called in LateUpdate for the local (controlling) player
            /// </summary>
            public virtual void CustomLateUpdate(Kit_PlayerBehaviour pb, double revertTime) { }

            /// <summary>
            /// Called in FixedUpdate for the local (controlling) player
            /// </summary>
            public virtual void CustomFixedUpdate(Kit_PlayerBehaviour pb, double revertTime) { }
            ...
            public abstract void DropWeapon(Kit_PlayerBehaviour pb, int slot);

            public abstract void DropWeapon(Kit_PlayerBehaviour pb, int slot, Transform transform);
            ...
            public abstract void PluginSelectWeapon(Kit_PlayerBehaviour pb, Kit_WeaponBase theWeapon, bool locked = true);
