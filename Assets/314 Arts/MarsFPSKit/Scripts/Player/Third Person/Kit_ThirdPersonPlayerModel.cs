...
namespace MarsFPSKit
{
    ...
    /// </summary>
    public abstract class Kit_ThirdPersonPlayerModel : Kit_Base
    {
        /// <summary>
        ...
        [Header("Damages")]
        public Kit_PlayerDamageMultiplier[] damageMultipliers;
        ...
        public void SetCustomizations(int[] enabledCustomizations, Kit_PlayerBehaviour pb)
        {
            ...
            for (int i = 0; i < enabledCustomizations.Length; i++)
            {
                ...
                {
                    DebugLogWarning("Something must have gone wrong with the customizations. Enabled customizations is longer than all slots.");
                }
            }
        }
    }
