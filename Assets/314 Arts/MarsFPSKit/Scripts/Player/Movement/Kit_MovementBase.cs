...
namespace MarsFPSKit
{
    ...
    public abstract class Kit_MovementBase : Kit_WeaponInjection
    {
        ...
        /// </summary>
        /// <param name="pb"></param>
        public virtual void NotControllerUpdate(Kit_PlayerBehaviour pb) { }
        public virtual void OnFixedUpdate(Kit_PlayerBehaviour pb) { }
        ...
        /// <param name="pb"></param>
        /// <returns></returns>
        public abstract Vector3 GetLocalVelocity(Kit_PlayerBehaviour pb);
