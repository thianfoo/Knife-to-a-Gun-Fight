...
namespace MarsFPSKit.Services
{
    ...
    public class Kit_MasterServerUgsLobby : Kit_MasterServerBase
    {
        ...
        public override void Initialize()
        {
            ...
            {
                DebugLogWarning("No UGS instance found. Will not work without UGS.");
            }
        }
        ...
        public override void GameServerInfoUpdated(Kit_NetworkGameInformation gameInfo)
        {
            if (activeLobby != null)
            {
                ...
                if (networkPlayerManager)
                {
                    players = networkPlayerManager.players.Count.ToString();
                }
        ...
        async void FetchTheirSouls()
        {
            try
            {
                ...
                //Redraw games
                Kit_MenuServerBrowser serverBrowser = FindAnyObjectByType<Kit_MenuServerBrowser>();
                if (serverBrowser)
                {
