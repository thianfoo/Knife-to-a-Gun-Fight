...
namespace MarsFPSKit
{
    ...
    public class Kit_BotManager : Kit_BaseNetworked
    {
        ...
        {
            if (main.gameInformation.allPvpGameModes[main.currentGameMode].CanSpawn(bot))
            {
                //Get a spawn
                Transform spawnLocation = main.gameInformation.allPvpGameModes[main.currentGameMode].GetSpawn(bot);
                if (spawnLocation)
                {
                    //Assign the values
                    ...
                    else
                    {
                        ...
                        Loadout loadout = main.currentPvPGameModeBehaviour.DoCustomSpawnBot(bot);
                        GameObject go = Instantiate(main.playerPrefab, spawnLocation.position, spawnLocation.rotation);
                        Kit_PlayerBehaviour pb = go.GetComponent<Kit_PlayerBehaviour>();
                        pb.myTeam = bot.team;
                        pb.isBot = true;
        ...
        public Kit_Bot AddNewBot()
        {
            ...
            //Send chat message
            main.chat.SendBotMessage(newBot, "Hey guys", 0);
            bots.Add(newBot);
        ...
        public void RemoveRandomBot()
        {
            ...
            //Send chat message
            main.chat.SendBotMessage(toRemove, "Bye guys", 1);
        ...
        public int GetPlayersInTeamX(int team)
        {
            ...
            {
                if (networkPlayerManager.players[i].team == team) toReturn++;
            }
            return toReturn;
        }
