...
namespace MarsFPSKit
{
    namespace Weapons
    {
        ...
        public class Kit_ModernGrenadeScriptEditor : UnityEditor.Editor
        {
            ...
            SerializedProperty weaponCatProperty;
            SerializedProperty weaponSubCatProperty;
            ...
            void OnEnable()
            {
                ...
                weaponCatProperty = serializedObject.FindProperty("weaponType");
                weaponSubCatProperty = serializedObject.FindProperty("weaponLoadoutSubCategory");
            }
            ...
            public override void OnInspectorGUI()
            {
                ...
                if (settingsFoldout)
                {
                    ...
                    EditorGUILayout.PropertyField(weaponNameProperty, true);
                    ...
                    EditorGUI.BeginChangeCheck();
                    EditorGUILayout.PropertyField(weaponCatProperty, true);
                    if (EditorGUI.EndChangeCheck())
                    {
                        serializedObject.ApplyModifiedProperties();
                        Repaint();
                    ...
                    EditorGUI.BeginChangeCheck();
                    EditorGUILayout.PropertyField(weaponSubCatProperty, true);
                    if (EditorGUI.EndChangeCheck())
                    {
                        serializedObject.ApplyModifiedProperties();
                        Repaint();
