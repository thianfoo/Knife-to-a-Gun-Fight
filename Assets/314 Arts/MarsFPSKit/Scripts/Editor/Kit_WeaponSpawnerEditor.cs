...
namespace MarsFPSKit
{
    ...
    public class Kit_WeaponSpawnerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Kit_IngameMain instance = FindAnyObjectByType<Kit_IngameMain>();
                ...
                else
                {
                    ...
                    if (foldoutWeapons)
                    {
                        for (int i = 0; i < spawner.weaponsToSpawn.Length; i++)
                        {
                            ...
                            GUILayout.Label("Selected Weapon: " + instance.gameInformation.allWeapons[spawner.weaponsToSpawn[i].weaponID].weaponName.GetLocalizedString());
