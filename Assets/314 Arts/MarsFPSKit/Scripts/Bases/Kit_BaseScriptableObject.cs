...
{
    /// <summary>
    /// This script acts as a base for all ScriptableObject scripts and supplies static references
    /// for cleaner code aswell as a unified Debug system.
    /// </summary>
    public abstract class Kit_BaseScriptableObject : ScriptableObject
    {
        ...
        protected Kit_ScriptableObjectCoroutineHelper coroutineHelper
        {
            get
            {
                return Kit_ScriptableObjectCoroutineHelper.instance;
            }
        }
