...
namespace MarsFPSKit
{
    public abstract class Kit_PvP_GameModeBase : Kit_WeaponInjection
    {
        ...
        public virtual void GameModeBeginMiddle()
        {
            ...
            Kit_WeaponSpawner[] weaponSpawners = FindObjectsByType<Kit_WeaponSpawner>(FindObjectsSortMode.None);
            //Reset them
            ...
            Kit_AmmoSpawner[] ammoSpawners = FindObjectsByType<Kit_AmmoSpawner>(FindObjectsSortMode.None);
            //Reset
            ...
            Kit_DestroyUponGameModeReset[] resets = FindObjectsByType<Kit_DestroyUponGameModeReset>(FindObjectsSortMode.None);
        ...
        public virtual void OnPlayerJoined(Kit_Player player)
        {

        }

        public virtual void OnPlayerLeft(Kit_Player player)
        {

        }

        public virtual bool CanCreateRagdolls()
        {
            return true;
        }
