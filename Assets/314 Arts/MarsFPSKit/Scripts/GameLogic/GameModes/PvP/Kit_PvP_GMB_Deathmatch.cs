...
namespace MarsFPSKit
{
    ...
    public class Kit_PvP_GMB_Deathmatch : Kit_PvP_GameModeBase
    {
        ...
        {
            Kit_PvP_GMB_DeathmatchNetworkData drd = main.currentGameModeRuntimeData as Kit_PvP_GMB_DeathmatchNetworkData;
            if (drd)
            {
        ...
        void CheckForWinner()
        {
            ...
            if (main.gameModeStage < 2 && main.gameModeStage > 0)
            {
                ...
                Kit_PlayerBehaviour[] players = FindObjectsByType<Kit_PlayerBehaviour>();
        ...
        */
        ...
        public override void TimeRunOut()
        {
            ...
            else if (main.gameModeStage == 1)
            {
                ...
                if (wonPlayer != null)
                {
                    DebugLog("Deathmatch ended. Winner: " + wonPlayer);
                    //We have a winner, tell the world (other players) about it
                    main.EndGame(wonPlayer);
                }
                else
                {
                    DebugLog("Deathmatch ended. No winner");
        ...
        public override bool AreWeEnemies(bool botEnemy, uint enemyId)
        {
            ...
            if (!botEnemy && enemyId == networkPlayerManager.myId) return false;
            //Everyone is enemies
            return true;
        }
