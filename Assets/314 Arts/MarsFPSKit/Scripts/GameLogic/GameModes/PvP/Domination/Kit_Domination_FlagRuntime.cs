...
{
    public class Kit_Domination_FlagRuntime : Kit_BaseNetworked
    {
        [SyncVar]
        /// <summary>
        ...
        /// </summary>
        public Kit_PlayerSpawn[] spawnForFlag = new Kit_PlayerSpawn[0];

        /// <summary>
        /// Nav points for capturing this flag!
        /// </summary>
        public Kit_BotNavPoint[] navPointsForFlag = new Kit_BotNavPoint[0];

        public List<Kit_BotNavPoint> navPointsAvailable = new List<Kit_BotNavPoint>();
        ...
        public Kit_BotNavPoint GetNavPoint()
        {
            if (navPointsAvailable.Count > 0)
            {
                Kit_BotNavPoint np = navPointsAvailable[Random.Range(0, navPointsAvailable.Count)];
                navPointsAvailable.Remove(np);
                return np;
            }

            return navPointsForFlag[Random.Range(0, navPointsForFlag.Length)];
        }

        public void ReleaseNavPoint(Kit_BotNavPoint navPoint)
        {
            navPointsAvailable.Add(navPoint);
        }
        ...
        {
            FindAnyObjectByType<Kit_PvP_GMB_DominationNetworkData>().flags.Add(this);
        }

        public override void OnStartClient()
        {
            var gameModeData = FindAnyObjectByType<Kit_PvP_GMB_DominationNetworkData>();
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            if (pb)
            {
                ...
                (main.currentPvPGameModeBehaviour as Kit_PvP_GMB_Domination).FlagStateChanged(this);
            }
        }
