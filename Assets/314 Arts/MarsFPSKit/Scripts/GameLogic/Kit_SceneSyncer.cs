...
namespace MarsFPSKit
{
    ...
    /// </summary>
    public class Kit_SceneSyncer : Kit_Base
    {
        public static Kit_SceneSyncer instance { get; private set; }
        /// <summary>
        /// Game Information
        /// </summary>
        ...
        public void LoadScene(string scene, bool forceLocal = false)
        {
            DebugLog("Trying to load scene now: " + scene);

            if (!networkManager.isNetworkActive || forceLocal)
            {
