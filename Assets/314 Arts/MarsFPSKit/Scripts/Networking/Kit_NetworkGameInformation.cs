...
namespace MarsFPSKit
{
    namespace Networking
    {
        ...
        /// </summary>
        public class Kit_NetworkGameInformation : Kit_BaseNetworked
        {
            /// <summary>
            /// Active instance
            /// </summary>
            public static Kit_NetworkGameInformation instance { get; private set; }
            ...
            {
                if (networkManager.game.masterServer && !networkManager.isOfflineMode)
                {
                    networkManager.game.masterServer.GameServerInfoUpdated(this);
                }
            }
            ...
            public void OnGameModeTypeChanged(int was, int isNow)
            {
                ...
                if (main)
                {
                    main.currentGameModeType = isNow;
                }
            }
            ...
            {
                if (networkManager && networkManager.game.masterServer && !networkManager.isOfflineMode)
                {
                    networkManager.game.masterServer.GameServerExited(this);
                }
            }
            #endregion
            ...
            public override void OnStartServer()
            {
                if (networkManager.game.masterServer && !networkManager.isOfflineMode)
                {
                    networkManager.game.masterServer.GameServerStarted(this);
            ...
            public override void OnStartClient()
            {
                ...
                networkManager.onConnectedToServer.Invoke();
            }
            #endregion
            ...
            IEnumerator Heartbeat()
            {
                while (true)
                {
                    networkManager.game.masterServer.Heartbeat(this);
