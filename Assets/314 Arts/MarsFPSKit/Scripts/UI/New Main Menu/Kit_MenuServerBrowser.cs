...
{
    /// <summary>
    /// This implements a server browser that shows whatever service you have assigned in the game file.
    /// </summary>
    public class Kit_MenuServerBrowser : Kit_Base
    {
        /// <summary>
        /// Menu Manager
        /// </summary>
        ...
        public void RedrawGames()
        {
            if (game.masterServer)
            {
                GameInfo[] infos = game.masterServer.GetGames();
        ...
        {
            networkManager.JoinGame(passwordRoom, passwordInput.text);
        }
