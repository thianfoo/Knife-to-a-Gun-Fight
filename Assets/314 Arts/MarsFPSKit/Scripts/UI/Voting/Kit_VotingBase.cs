...
namespace MarsFPSKit
{
    ...
    /// </summary>
    public abstract class Kit_VotingBase : Kit_BaseNetworked
    {
        ...
        public void CmdVoteYes()
        {
            NetworkConnectionToClient sender = connectionToClient;
            OnVoteYes(networkPlayerManager.GetPlayerByConnection(sender));
        }
        ...
        [Command(requiresAuthority = false)]
        public void CmdVoteNo()
        {
            NetworkConnectionToClient sender = connectionToClient;
            OnVoteNo(networkPlayerManager.GetPlayerByConnection(sender));
        }
