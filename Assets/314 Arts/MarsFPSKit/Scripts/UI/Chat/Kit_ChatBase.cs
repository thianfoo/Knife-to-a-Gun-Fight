...
namespace MarsFPSKit.UI
{
    ...
    /// </summary>
    public abstract class Kit_ChatBase : Kit_Base
    {
        /// <summary>
        ...
        {
            main.CmdChatMessage(content, targets);
        }

        public void SendBotMessage(Kit_Bot botSender, string msg, byte type)
        {
            main.RpcChatMessage(true, botSender.id, msg, type);
            DebugLog("Bot message: " + botSender.name + ": " + msg);
        }
    }
}
