...
namespace MarsFPSKit.UI
{
    public class Kit_SimpleChat : Kit_ChatBase
    {
        ...
        public LocalizedString sayToAll;
        public LocalizedString sayToTeam;
        ...
        public override void DisplayChatMessage(Kit_Player sender, string message, byte type)
        {
            ...
            DebugLog("Chat message from: " + sender.name + ": " + message);
        }
            ...
            if (!Kit_IngameMain.isPauseMenuOpen)
            {
                if (inputSystem.chat)
                {
                    if (!isChatOpen)
                    {
                        ...
                        chatPlaceholder.text = sayToAll.GetLocalizedString(); //Display correct placeholder
                ...
                else if (inputSystem.chat)
                {
                    if (!isChatOpen)
                    {
                        ...
                        if (main.currentPvPGameModeBehaviour && main.currentPvPGameModeBehaviour.isTeamGameMode)
                        {
                            chatPlaceholder.text = sayToTeam.GetLocalizedString();//Display correct placeholder
                        }
                        else
                        {
                            chatPlaceholder.text = sayToAll.GetLocalizedString(); //Display correct placeholder
