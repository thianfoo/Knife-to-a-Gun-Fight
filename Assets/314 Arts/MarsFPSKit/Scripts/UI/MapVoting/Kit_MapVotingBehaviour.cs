...
namespace MarsFPSKit
{
    ...
    public class Kit_MapVotingBehaviour : Kit_BaseNetworked
    {
        /// <summary>
        ...
        public override void OnStartClient()
        {
            ...
            main.MapVotingOpened();
            //Setup the UI
            main.mapVotingUI.SetupVotes(this);

            currentVotes.OnChange += OnVotesChanged;
        }
        ...
        {
            Kit_Player player = networkPlayerManager.GetPlayerByConnection(who);
