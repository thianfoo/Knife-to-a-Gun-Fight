...
namespace MarsFPSKit
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "MarsFPSKit/Game Settings/New")]
    public class Kit_GameInformation : Kit_BaseScriptableObject
    {
        public bool debugGlobalOverride;
        ...
        /// Weapon categories!
        /// </summary>
        public LocalizedString[] allWeaponCategories;
        /// <summary>
        /// The default weapons in the respective slot!
        /// </summary>
        public Kit_WeaponBase[] defaultWeaponsInSlot;
        ...
        [Tooltip("Should we automatically reload when empty mag and still ammo left?")]
        /// <summary>
        /// Should we automatically reload when empty mag and still ammo left?
        /// </summary>
        public bool enableAutoReload;
        [Tooltip("How much tolerance the lag compensation test has")]
        /// <summary>
        /// How much tolerance the lag compensation test has
        /// </summary>
        public float lagCompensationTolerancePercent = 0.03f;
        ...
        /// </summary>
        [Tooltip("These layers will be hit by Raycasts that weapons use")]
        public LayerMask weaponHitLayersNoPlayers;
        ...
        public Kit_MapInformation GetMapInformationFromSceneName(string scene)
        {
            ...
            {
                DebugLogWarning("Error when iterating through all pvp game modes and maps: " + e);
            }
            ...
            {
                DebugLogWarning("Error when iterating through all singleplayer game modes and maps: " + e);
            }
            ...
            {
                DebugLogWarning("Error when iterating through all coop game modes and maps: " + e);
            }
        ...
        public UnlockInformation[] GetUnlockedItemsAtLevel(int lvl)
        {
            ...
            for (int i = 0; i < allWeapons.Length; i++)
            {
                ...
                if (allWeapons[i].levelToUnlockAt == lvl)
                {
                    ...
                    //Assign info
                    ui.name = allWeapons[i].weaponName.GetLocalizedString();
