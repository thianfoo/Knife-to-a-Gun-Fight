...
namespace MarsFPSKit
{
    ...
    {
        /// <summary>
        /// Each plugin gets 16 codes. +0 - +15
        /// </summary>
        public byte startEventCode; 
        ...
        /// <summary>
        /// Always started by server, only received by this client!
        /// </summary>
        /// <param name="target"></param>
        /// <param name="eventCode"></param>
        /// <param name="content"></param>
        public virtual void OnTargetGenericEvent(NetworkConnectionToClient target, byte eventCode, object content)
        {
        ...
        public virtual void PlayerScoredKill(bool botShot, uint killer, bool botKilled, uint killed, int gunId, int thirdPersonPlayerModelId, int ragdollId)
        {

        }

        public virtual void PlayerScoredKill(bool botShot, uint killer, bool botKilled, uint killed, string cause, int thirdPersonPlayerModelId, int ragdollId)
        {
